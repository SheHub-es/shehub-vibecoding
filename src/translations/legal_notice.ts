...
export const legalNoticeTranslations: TranslationObject = {
  ...
  'legal.notice.responsibility.title': {
    ...
    cat: 'Limitació de Responsabilitat',
  },
  'legal.notice.responsibility.content': {
    ...
    cat: 'SheHub no es fa responsable dels danys que puguin derivar-se del mal ús del contingut disponible en aquest lloc web o de l\'accés a enllaços externs proporcionats a la nostra plataforma. Els usuaris accedeixen i utilitzen aquest contingut sota el seu propi risc i responsabilitat.',
  },
  ...
  'legal.notice.usage.prohibited': {
    ...
    cat: 'Qualsevol activitat il·legal, perjudicial, difamatòria o disruptiva està estrictament prohibida i pot resultar en la suspensió immediata de l\'accés a la plataforma.',
  },
  ...
  'legal.notice.law.content': {
    ...
    cat: 'Aquest avís legal i l\'ús d\'aquest lloc web es regeixen per la legislació espanyola. Qualsevol disputa que sorgeixi de l\'ús d\'aquest lloc web estarà subjecta a la jurisdicció exclusiva dels tribunals de Barcelona, Espanya.',
  },
