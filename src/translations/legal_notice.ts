...
export const legalNoticeTranslations: TranslationObject = {
  'legal.notice.title': {
    en: 'Legal Notice',
    es: 'Aviso Legal',
    ca: 'Avís Legal',
  },
  'legal.notice.entity.title': {
    en: 'Entity Information',
    es: 'Información de la Entidad',
    ca: 'Informació de l\'Entitat',
  },
  'legal.notice.entity.name': {
    en: 'Organization Name',
    es: 'Nombre de la Organización',
    ca: 'Nom de l\'Organització',
  },
  'legal.notice.entity.email': {
    en: 'Contact Email',
    es: 'Email de Contacto',
    ca: 'Correu de Contacte',
  },
  'legal.notice.purpose.title': {
    en: 'Purpose and Mission',
    es: 'Propósito y Misión',
    ca: 'Propòsit i Missió',
  },
  ...
  'legal.notice.responsibility.content': {
    en: 'SheHub is not liable for any damages that may arise from the misuse of the content available on this website or from accessing external links provided on our platform. Users access and use this content at their own risk and responsibility.',
    es: 'SheHub no se hace responsable de los daños que puedan derivarse del mal uso del contenido disponible en este sitio web o del acceso a enlaces externos proporcionados en nuestra plataforma. Los usuarios acceden y utilizan este contenido bajo su propio riesgo y responsabilidad.',
    ca: 'SheHub no es fa responsable dels danys que puguin derivar-se del mal ús del contingut disponible en aquest lloc web o de l\'accés a enllaços externs proporcionats a la nostra plataforma. Els usuaris accedeixen i utilitzen aquest contingut sota el seu propi risc i responsabilitat.',
  },
  'legal.notice.usage.title': {
    en: 'Terms of Use',
  ...
  'legal.notice.usage.responsible': {
    ...
    ca: 'Els usuaris han d\'utilitzar aquest lloc web de manera responsable i ètica, respectant els drets d\'altres usuaris i les pautes de la comunitat de la plataforma.',
  },
  'legal.notice.usage.prohibited': {
    ...
    es: 'Cualquier actividad ilegal, dañina, difamatoria o disruptiva está estrictamente prohibida y puede resultar en la suspensión inmediata del acceso a la plataforma.',
    ca: 'Qualsevol activitat il·legal, perjudicial, difamatòria o disruptiva està estrictament prohibida i pot resultar en la suspensió immediata de l\'accés a la plataforma.',
  },
  ...
  'legal.notice.cookies.content': {
    ...
    ca: 'Aquest lloc web utilitza galetes per millorar l\'experiència de l\'usuari i analitzar el trànsit del lloc web a través de serveis com Google Analytics. En continuar utilitzant aquest lloc, vostè consent l\'ús de galetes d\'acord amb la nostra política de galetes.',
  },
  'legal.notice.cookies.link': {
    en: 'View our complete Cookie Policy',
    es: 'Ver nuestra Política de Cookies completa',
    ca: 'Veure la nostra Política de Galetes completa',
  },
  'legal.notice.law.title': {
    en: 'Applicable Law and Jurisdiction',
    es: 'Legislación Aplicable y Jurisdicción',
    ca: 'Legislació Aplicable i Jurisdicció',
  },
  'legal.notice.law.content': {
    ...
    es: 'Este aviso legal y el uso de este sitio web se rigen por la legislación española. Cualquier disputa que surja del uso de este sitio web estará sujeta a la jurisdicción exclusiva de los tribunales de Barcelona, España.',
    ca: 'Aquest avís legal i l\'ús d\'aquest lloc web es regeixen per la legislació espanyola. Qualsevol disputa que sorgeixi de l\'ús d\'aquest lloc web estarà subjecta a la jurisdicció exclusiva dels tribunals de Barcelona, Espanya.',
  },
  'legal.notice.last_updated': {
    en: 'Last updated',
