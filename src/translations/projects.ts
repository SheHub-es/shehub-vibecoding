...
export const projectsTranslations: TranslationObject = {
  ...
  'projects.headline': {
    ...
    cat: 'Obté experiència valuosa a través de la col·laboració',
  },
  ...
  'projects.cta': {
    ...
    cat: 'Uneix-te a la nostra plataforma',
  },
  'projects.diverse': {
    en: 'Diverse Teams',
    es: 'Equipos Diversos',
