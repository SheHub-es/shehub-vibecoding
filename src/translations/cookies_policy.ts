...
export const cookiesPolicyTranslations: TranslationObject = {
  ...
  'cookies.policy.what.content': {
    ...
    cat: 'Les galetes són petits fitxers de text que s\'emmagatzemen al teu dispositiu quan visites el nostre lloc web. Ens ajuden a oferir-te una millor experiència recordant les teves preferències i analitzant com uses la nostra plataforma.',
  },
  'cookies.policy.types.title': {
    en: 'Types of cookies we use',
    es: 'Tipos de cookies que utilizamos',
    cat: 'Tipus de galetes que utilitzem',
  },
  ...
  'cookies.policy.types.analytics': {
    ...
    cat: 'Galetes d\'anàlisi: Ens ajuden a entendre com els visitants interactuen amb el nostre lloc web a través de Google Analytics',
  },
