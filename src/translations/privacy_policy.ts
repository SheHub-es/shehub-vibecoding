...
export const privacyPolicyTranslations: TranslationObject = {
  ...
  'privacy.policy.data_collected.description': {
    ...
    cat: 'Recollim les següents dades personals:',
  },
  ...
  'privacy.policy.data_collected.analytics': {
    ...
    cat: 'També podem recopilar informació sobre l’ús del nostre web mitjançant eines d’anàlisi com Google Analytics.',
  },
  'privacy.policy.usage.title': {
    en: 'Purpose of Data Processing',
    es: 'Finalidad del Tratamiento de los Datos',
    cat: 'Finalitat del Tractament de Dades',
  },
  ...
  'privacy.policy.usage.waitlists': {
    ...
    cat: 'Gestionar llistes d’espera i informació de participants per a activitats o programes de SheHub.',
  },
  'privacy.policy.usage.groups': {
    en: 'To participate in SheHub working groups.',
    es: 'Participar en grupos de trabajo de SheHub.',
    cat: 'Participar en grups de treball de SheHub.',
  },
  'privacy.policy.usage.mentorship': {
    ...
    cat: 'Compartir el teu nom i correu electrònic amb grups i mentors dins de la plataforma.',
  },
  ...
  'privacy.policy.rights.opposition': {
    ...
    cat: 'Oposar-te al tractament de les teves dades per a finalitats específiques.',
  },
  'privacy.policy.rights.contact': {
    ...
    cat: 'Per exercir aquests drets,  pots contactar-nos a:',
  },
  ...
  'privacy.policy.retention.content': {
    ...
    cat: 'Conservarem les teves dades mentre el teu perfil estigui actiu o mentre siguin necessàries per als fins recollits. Si decideixes eliminar el perfil o sol·licites l’eliminació de les dades, procedirem a fer-ho de manera immediata.',
  },
