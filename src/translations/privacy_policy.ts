...
export const privacyPolicyTranslations: TranslationObject = {
  'privacy.policy.title': {
    ...
    ca: 'Política de Privacitat de SheHub',
  },
  ...
  'privacy.policy.data_collected.description': {
    en: 'We collect the following personal data:',
    es: 'Recogemos los siguientes datos personales:',
    ca: 'Recollim les següents dades personals:',
  },
  'privacy.policy.data_collected.name': {
    en: 'Name.',
    es: 'Nombre.',
    ca: 'Nom.',
  },
  'privacy.policy.data_collected.email': {
    en: 'Email address.',
  ...
  'privacy.policy.data_collected.experience': {
    ...
    ca: 'Experiència professional i educativa.',
  },
  'privacy.policy.data_collected.city': {
    en: 'City of residence.',
    es: 'Ciudad de residencia.',
    ca: 'Ciutat de residència.',
  },
  'privacy.policy.data_collected.linkedin': {
    en: 'LinkedIn profile.',
    es: 'Perfil de LinkedIn.',
    ca: 'Perfil de LinkedIn.',
  },
  'privacy.policy.data_collected.analytics': {
    en: 'Additionally, we may collect information about how you use our website through analytics tools such as Google Analytics.',
    es: 'Además, podemos recopilar información sobre el uso de nuestra web mediante herramientas de análisis como Google Analytics.',
    ca: 'També podem recopilar informació sobre l’ús del nostre web mitjançant eines d’anàlisi com Google Analytics.',
  },
  'privacy.policy.usage.title': {
    en: 'Purpose of Data Processing',
    es: 'Finalidad del Tratamiento de los Datos',
    ca: 'Finalitat del Tractament de Dades',
  },
    'privacy.policy.usage.description': {
    en: 'We use your personal data for the following purposes:',
    es: 'Utilizamos tus datos personales para los siguientes fines:',
    ca: 'Utilitzem les teves dades personals per a les finalitats següents:',
  },
  'privacy.policy.usage.newsletter': {
    en: 'To send newsletters and communications.',
    es: 'Enviar newsletters y comunicaciones.',
    ca: 'Enviar newsletters i comunicacions.',
  },
  'privacy.policy.usage.waitlists': {
    en: 'To manage waitlists and participant information for SheHub activities or programs.',
    es: 'Gestionar listas de espera e información de participantes para actividades o programas de SheHub.',
    ca: 'Gestionar llistes d’espera i informació de participants per a activitats o programes de SheHub.',
  },
  'privacy.policy.usage.groups': {
    en: 'To participate in SheHub working groups.',
    es: 'Participar en grupos de trabajo de SheHub.',
    ca: 'Participar en grups de treball de SheHub.',
  },
  'privacy.policy.usage.mentorship': {
    en: 'To share your name and email with groups and mentors within the platform.',
    es: 'Compartir tu nombre y correo electrónico con grupos y mentores dentro de la plataforma.',
    ca: 'Compartir el teu nom i correu electrònic amb grups i mentors dins de la plataforma.',
  },
  'privacy.policy.legal_basis.title': {
    en: 'Legal Basis for Data Processing',
    es: 'Base Legal para el Tratamiento de los Datos ',
    ca: 'Base Legal pel Tractament de les Dades',
  },
  'privacy.policy.legal_basis.content': {
    ...
    ca: 'La base legal per tractar les teves dades és el teu <strong style="color: black"> consentiment explícit</strong>. En proporcionar les teves dades personals i participar en grups de treball, ens dones el teu consentiment per utilitzar-les segons aquesta política de privacitat.<br><br>Si decideixes no proporcionar les dades o retirar el teu consentiment, podràs continuar utilitzant la plataforma amb certes restriccions, segons el cas.',
  },
  'privacy.policy.sharing.title': {
    en: 'Data Recipients',
    es: 'Destinatarios de los Datos',
    ca: 'Destinataris de les Dades',
  },
    'privacy.policy.sharing.description': {
    en: 'We share your data with:',
    es: 'Compartimos tus datos con:',
    ca: 'Compartim les teves dades amb:',
  },
  'privacy.policy.sharing.groups': {
    en: 'Members of your working group.',
    es: 'Miembros de tu grupo de trabajo.',
    ca: 'Membres del teu grup de treball.',
  },
  'privacy.policy.sharing.mentors': {
    en: 'SheHub mentors.',
    es: 'Mentoras de SheHub.',
    ca: 'Mentores de SheHub.',
  },
  'privacy.policy.sharing.team': {
    en: 'The SheHub team managing the platform.',
    es: 'El equipo de SheHub que gestiona la plataforma.',
    ca: 'L’equip de SheHub que gestiona la plataforma.',
  },
  'privacy.policy.rights.title': {
    en: 'User Rights',
    es: 'Derechos de los Usuarios',
    ca: 'Drets dels Usuaris',
  },
    'privacy.policy.rights.description': {
    en: 'You have the right to:',
    es: 'Tienes derecho a:',
    ca: 'Tens dret a:',
  },
  'privacy.policy.rights.access': {
    en: 'Access your personal data.',
    es: 'Acceder a tus datos personales.',
    ca: 'Accedir a les teves dades personals.',
  },
  'privacy.policy.rights.rectification': {
    ...
    ca: 'Rectificar dades incorrectes o incompletes.',
  },
  'privacy.policy.rights.deletion': {
    ...
    ca: 'Sol·licitar l’eliminació de les teves dades quan ja no siguin necessàries o si decideixes tancar el teu perfil a SheHub.',
  },
  'privacy.policy.rights.opposition': {
    en: 'Object to the processing of your data for specific purposes.',
    es: 'Oponerte al tratamiento de tus datos para fines específicos.',
    ca: 'Oposar-te al tractament de les teves dades per a finalitats específiques.',
  },
  'privacy.policy.rights.contact': {
    en: 'To exercise these rights, contact us at:',
    es: 'Para ejercer estos derechos, puedes contactarnos a través del correo electrónico:',
    ca: 'Per exercir aquests drets,  pots contactar-nos a:',
  },
  'privacy.policy.security.title': {
    en: 'Data Security',
    es: 'Seguridad de los Datos',
    ca: 'Seguretat de les Dades',
  },
  'privacy.policy.usage.analytics': {
    ...
    ca: 'Implementem mesures de seguretat per protegir les teves dades personals d\'accés no autoritzat, pèrdua o alteració. Utilitzem serveis d\'emmagatzematge segurs com Firebase i Airtable, i prenem precaucions raonables per mantenir les teves dades protegides.',
  },
  'privacy.policy.retention.title': {
    en: 'Data Retention',
    es: 'Retención de los Datos',
    ca: 'Conservació de les Dades',
  },
  'privacy.policy.retention.content': {
    en: 'We will retain your personal data while your profile remains active or as needed for the purposes for which it was collected. If you choose to delete your profile or request deletion of your data, we will proceed with immediate removal.',
    es: 'Conservaremos tus datos personales mientras mantengas tu perfil activo o mientras sea necesario para los fines por los cuales se recopilaron. Si decides eliminar tu perfil o solicitar la eliminación de tus datos, procederemos con la eliminación inmediata.',
    ca: 'Conservarem les teves dades mentre el teu perfil estigui actiu o mentre siguin necessàries per als fins recollits. Si decideixes eliminar el perfil o sol·licites l’eliminació de les dades, procedirem a fer-ho de manera immediata.',
  },
  'privacy.policy.transfers.title': {
    en: 'International Data Transfers',
    es: 'Transferencias Internacionales de Datos',
    ca: 'Transferències Internacionals de Dades',
  },
  ...
  'privacy.policy.contact.content': {
    ...
    ca: 'Si tens alguna pregunta sobre aquesta política de privacitat o les nostres pràctiques de dades, si us plau contacta\'ns a',
  },
