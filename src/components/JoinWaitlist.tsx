    ...
    <section id="join" className={cn("py-24 bg-[#F8F5FF]", className)}>
      <div className="container max-w-4xl mx-auto px-6 md:px-8">
        <div className="text-center max-w-2xl mx-auto">
          <FadeIn>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to grow or give back?</h2>
          </FadeIn>
          
          <FadeIn delay={0.1}>
            <p className="text-lg text-muted-foreground mb-8">
              Whether you're pivoting into tech or growing as a leader, SheHub is your space to contribute and thrive.
            </p>
          </FadeIn>
