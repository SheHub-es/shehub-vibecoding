    ...
    <section id="join" className={cn("py-24 bg-white", className)}>
      <div className="container max-w-4xl mx-auto px-6 md:px-8">
        <div className="text-center max-w-2xl mx-auto">
          <FadeIn>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">{t('joinwaitlist.title')}</h2>
          </FadeIn>
          
          <FadeIn delay={0.1}>
            <p className="text-lg text-muted-foreground mb-8">
              {t('joinwaitlist.description')}
            </p>
          </FadeIn>
          ...
          <FadeIn delay={0.2}>
            ...
            >
              {t('joinwaitlist.button')} <ArrowRight className="ml-2" size={18} />
            </a>
            
            <p className="text-sm text-muted-foreground mt-4">
              {t('joinwaitlist.footer')}
            </p>
          </FadeIn>
        </div>
      </div>
